...
ini_set('error_log', __DIR__ . '/../logs/php_error.log'); // Ruta al archivo de log
error_reporting(E_ALL & ~E_DEPRECATED & ~E_WARNING); // Puedes ajustar según lo que quieras registrar
...
// Pagina 404, paginas no encontradas
