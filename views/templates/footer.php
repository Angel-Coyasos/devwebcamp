<footer class="footer">
    ...
    <div class="footer__grid">
        ...
        <div class="footer__contenido">
            ...
            <p class="footer__texto">
                DevWebCamp es una conferencia para desarrolladores de todos los niveles, se lleva a cabo de fomra presencial y en linea.
            </p>
        </div>
    ...
    <p class="footer__copyright">
        ...
        <span class="footer__copyright--regular">
            - Todos os derechos reservados <?= date('Y'); ?>
        </span>
    </p>
</footer>