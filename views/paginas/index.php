...
<?php
    require_once __DIR__ . '/conferencias.php'
?>
        ...
        <?php foreach ($ponentes as $ponente) : ?>
            <div  <?= aos_animacion(); ?> class="speaker">
                <picture>
                    ...
                    <img class="speaker__imagen" loading="lazy" width="200px" height="300" src="<?= $_ENV['HOST'] . '/img/speakers/' . $ponente->imagen; ?>.png" alt="Imagen Ponente">
                </picture>
                ...
                <div class="speaker__informacion">
                    ...
                    <nav class="speaker-sociales">
                        ...
                        <?php if ( !empty($redes->linkedin) ) : ?>
                            <a class="speaker-sociales__enlace" rel="noopener noreferrer" target="_blank" href="<?= $redes->linkedin; ?>">
