...
class ActiveRecord {
    ...
    // Retornar registro por un orden
    public static function ordenar($columna, $orden) {
        $query = "SELECT * FROM " . static::$tabla . " ORDER BY ${columna} ${$orden} "; // ORDER BY hora_id ASC
        $resultado = self::consultarSQL($query);
        return $resultado ;
    }
    ...
    public static function ordenarLimite($columna, $orden, $limite) {
        $query = "SELECT * FROM " . static::$tabla . " ORDER BY ${columna} ${$orden} LIMIT ${limite}"; // ORDER BY hora_id ASC
        $resultado = self::consultarSQL($query);
        return $resultado ;
    }
